...
class Bottom_attention_U_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        super(Bottom_attention_U_Net,self).__init__()
        ...
        # one attetnion block in the middle for a more complete picture
        self.Att = Attention_block(F_g=128,F_l=128,F_int=64)
...
def get_model():
    model = AttU_Net(3, 1)#U_Net, R2U_Net, AttU_Net, R2AttU_Net
    return model